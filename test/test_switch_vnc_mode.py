...
async def vnc_switch_mode():
    ...
    WaitForELinkKVMReady("10.42.0.2")
    ...
    if entry:
        ...
        if entry:
            entry.show()
    powermeter.getPowerInfo(vnc_switch_mode.__name__, Action.FILE_TRANSFER, ActionState.ACTION_FINISH)
...
if __name__ == '__main__':
    testScheduler.add_job(vnc_switch_mode, 'interval', seconds=5)
